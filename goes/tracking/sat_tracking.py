...
base_dir = '/home/scarani/Desktop/data/tracking/sat_grids/new/'
data_dir = '/home/scarani/Desktop/data/tracking/sat_grids/new/OR_ABI-L2-MCMIPM1-M3_G16_s2018174135*'
a = glob.glob(data_dir, recursive=True)
data_dir = '/home/scarani/Desktop/data/tracking/sat_grids/new/OR_ABI-L2-MCMIPM1-M3_G16_s201817414*'
b = glob.glob(data_dir, recursive=True)
data_dir = '/home/scarani/Desktop/data/tracking/sat_grids/new/OR_ABI-L2-MCMIPM1-M3_G16_s201817415*'
c = glob.glob(data_dir, recursive=True)
data_dir = '/home/scarani/Desktop/data/tracking/sat_grids/new/OR_ABI-L2-MCMIPM1-M3_G16_s201817416*'
d = glob.glob(data_dir, recursive=True)
data_dir = '/home/scarani/Desktop/data/tracking/sat_grids/new/OR_ABI-L2-MCMIPM1-M3_G16_s201817417*'
e = glob.glob(data_dir, recursive=True)

grid_files = a + b + c + d + e
...
animate(tracks_obj, anim_gen, '/home/scarani/Desktop/output/tracking/sat_20180623-25',

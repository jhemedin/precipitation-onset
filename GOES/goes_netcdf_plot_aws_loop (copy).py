...
def run():
    ...
    for i in range(t_delta.days,-1,-1):
        ...
        for a in range(0,24,1):
            edfileprefix = str('ABI-L2-MCMIPM' + (e_d.strftime('/%Y/%j/') + str(a).zfill(2)
                            + '/' + 'OR_ABI-L2-MCMIP' + scan + '-M3_G16_'))
...
"""
start_date='20180621'
start_date_time='210000'
end_date='20180621'
end_date_time='220000'
scan= 'M2'
run()

start_date='20180621'
start_date_time='220000'
end_date='20180621'
end_date_time='230000'
scan= 'M2'
run()

start_date='20180621'
start_date_time='230000'
end_date='20180621'
